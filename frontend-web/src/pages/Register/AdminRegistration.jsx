      ...
      <div className="container">
        <div className="register-form-container glass-panel">
          ...
          <form>
            ...
            <div className="form-group">
              <label>Email</label>
              <input type="email" className="form-control" placeholder="Enter your admin email" />
            </div>
            <div className="form-group">
            ...
            <button type="button" className="btn btn-primary w-100 mt-3">Register Admin</button>
          </form>
        </div>
      </div>
    </div>
